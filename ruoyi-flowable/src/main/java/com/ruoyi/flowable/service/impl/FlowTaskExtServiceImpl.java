...
import com.ruoyi.flowable.mapper.FlowTaskExtMapper;
...
public class FlowTaskExtServiceImpl extends BaseService<FlowTaskExt, String> implements FlowTaskExtService {
     ...
     */
    @Override
    public List<FlowTaskExt> getEntryExtByFlowKey(String flowKey) {
        return flowTaskExtMapper.getEntryExtByFlowKey(flowKey);
    }
}
