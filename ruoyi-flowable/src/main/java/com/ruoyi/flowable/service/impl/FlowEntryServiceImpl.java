...
import com.ruoyi.flowable.listener.FlowFinishedListener;
import com.ruoyi.flowable.mapper.FlowEntryMapper;
import com.ruoyi.flowable.mapper.FlowEntryPublishMapper;
import com.ruoyi.flowable.mapper.FlowEntryPublishVariableMapper;
...
public class FlowEntryServiceImpl extends BaseService<FlowEntry, Long> implements FlowEntryService {
    ...
    public List<FlowEntry> getFlowEntryByPublishId(String newEntryPublishId) {
        return flowEntryMapper.getFlowEntryByPublishId(newEntryPublishId);
    }
     ...
     */
    @Override
    public List<FlowEntry> getFlowEntryByFlowKey(String flowKey) {
        return flowEntryMapper.getFlowEntryByFlowKey(flowKey);
    }
