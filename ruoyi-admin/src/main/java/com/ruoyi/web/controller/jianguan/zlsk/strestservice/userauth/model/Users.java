...
public class Users
{
    ...
    public void setUgid(final Integer ugid) {
        this.ugid = ugid;
    }
    ...
    public void setMoblie(final String moblie) {
        this.moblie = moblie;
    }
    ...
    public void setSbsj(final String sbsj) {
        this.sbsj = sbsj;
    }
    ...
    public void setPwdOld(final String pwdOld) {
        this.pwdOld = pwdOld;
    }
