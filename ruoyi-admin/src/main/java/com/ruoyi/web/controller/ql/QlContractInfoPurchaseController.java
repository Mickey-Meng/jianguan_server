...
public class QlContractInfoPurchaseController extends BaseController {
    ...
    public void export(QlContractInfoPurchaseBo bo, HttpServletResponse response) {
        ...
        List<QlContractInfoPurchaseExport> qlContractInfoPurchaseExports = QlContractInfoPurchaseMapstruct.INSTANCES.toQlContractInfoPurchaseExports(list);
        ExcelUtil.exportExcel(qlContractInfoPurchaseExports, "采购合同 ", QlContractInfoPurchaseExport.class, response);
    }
