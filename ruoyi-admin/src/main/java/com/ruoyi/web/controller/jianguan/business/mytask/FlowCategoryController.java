...
import com.ruoyi.flowable.domain.dto.FlowCategoryDto;
import com.ruoyi.flowable.domain.vo.FlowCategoryVo;
...
public class FlowCategoryController {
    ...
    public ResponseResult<MyPageData<FlowCategoryVo>> list(
        ...
        return ResponseResult.success(MyPageUtil.makeResponseData(flowCategoryList, FlowCategory.FlowCategoryModelMapper.INSTANCE));
    }
    ...
    public ResponseResult<FlowCategoryVo> view(@RequestParam Long categoryId) {
        ...
        FlowCategoryVo flowCategoryVo = FlowCategory.FlowCategoryModelMapper.INSTANCE.fromModel(flowCategory);
