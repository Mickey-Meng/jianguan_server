...
/**
 * @Author : Chen_ZhiWei
 * @Date : Create file in 2022/6/2 10:19
 * @Version : 1.0
 * @Description :
 **/
public class SsFProjectsTree {
     ...
     * 级别(辅助字段,树状层级)
     */
    @ApiModelProperty(value = "级别(辅助字段,树状层级)")
    ...
    /**
     * 状态: -1: 删除, 0: 冻结, 1: 正常（后续状态待添加）
     */
    @ApiModelProperty(value = "状态: -1: 删除, 0: 冻结, 1: 正常（后续状态待添加）")
    ...
    public List<SsFProjectsTree> getChild() {
        return child;
    }

    public void setChild(List<SsFProjectsTree> child) {
        this.child = child;
    }
