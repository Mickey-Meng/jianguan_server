package com.ruoyi.jianguan.business.metrology.domain.vo;
...
@Data
@ApiModel(value = "MetrologyDetailVo", description = "计量详情返回VO")
public class MetrologyDetailVo extends NewBaseEntity {
