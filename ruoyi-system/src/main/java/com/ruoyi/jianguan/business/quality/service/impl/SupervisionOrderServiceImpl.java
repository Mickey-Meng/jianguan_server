...
import com.ruoyi.jianguan.business.quality.mapper.SupervisionOrderMapper;
...
public class SupervisionOrderServiceImpl extends ServiceImpl<SupervisionOrderMapper, SupervisionOrder> implements SupervisionOrderService {
    ...
    public PageInfo<SupervisionOrderPageVo> getPageInfo(SupervisionOrderPageDTO pageDto) {
        ...
        return MyPageUtil.getPageInfo(pageVoList.stream()
                .sorted(Comparator.comparing(SupervisionOrderPageVo::getCreateTime).reversed()), pageVoList.size(), pageDto.getPageSize(), pageDto.getPageNum());
    }
