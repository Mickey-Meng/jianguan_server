...
public class PlanConstructionDesignSaveDTO extends SaveDTO {
     ...
     * 施工图名称
     */
    @NotBlank(message = "施工图名称不能为空", groups = { AddGroup.class, EditGroup.class })
    private String name;

    /**
     * 施工图内容
     */
    @NotBlank(message = "施工图内容不能为空", groups = { AddGroup.class, EditGroup.class })
