package com.ruoyi.common.utils.jianguan.zjrw.httputils;
...
public class HttpClient {
    ...
    public static String doService(String url, HttpParamers paramers, HttpHeader header,
    ...
    public static String doPost(String url, HttpParamers paramers, HttpHeader header, int connectTimeout, int readTimeout) throws IOException  {
        ...
        try{
            ...
            query = paramers.getQueryString(DEFAULT_CHARSET).replace("\\", "");
