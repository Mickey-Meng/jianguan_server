...
public class ComponentType {
    ...
    public static void fillProduce(Produceandrecode produceandrecodeindex, ProduceRecord produceRecord, String type, Map<Integer, List<Produce>> collect2) {
        ...
        }else if("ZZDS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("ZXL".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("FPW".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("FZHL".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("QLZT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("QMFS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("QTQTDB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("QTDB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("TAIDB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SSF".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SSFAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("ZZAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DDXJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("HGB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SJF".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LBAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LBYZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("SDGJW".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("PSHNT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DKPS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("YQJZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("JIESG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("MDFS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("MDHT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDGQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDYG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("CQMG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("CQXDG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("CQGJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DGP".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDGJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("HNTCQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("YGHT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DSKW".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("AJJXJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("FSC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LYJSJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LYPSG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDMG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("PSGUAN".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("FSB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDLM".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDJC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDMC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DLG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SDZT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("LJTZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LJWF".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("TWJJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DPLD".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("CLHT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LSC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("JSG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("HXPSG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GLH".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("JLC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("PSGOU".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("PSDTQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GJZC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("JXPD".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("TFHP".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("WFHP".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("HLSG".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("YZLB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("BZQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("YZQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DNPZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GBAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GBYZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GJYZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("HBHT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("HGAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("JSQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("MHDB".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("MHPZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("TBHT".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("XHJZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DHX".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DSJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("GQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
        ...
        }else if("DJC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DIANC".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("LYS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DCXJ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("FZHLAZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("ZSZX".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DCFS".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("TDQ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("SJFJZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
            }
        }else if("DMYQJZ".equals(type)){
            Produce produce = collect2.get(produceandrecodeindex.getProduceid()).get(0);
            if(produce.getRange()==1){
                produceRecord.setOne(status);
                produceRecord.setOneTime(produceandrecodeindex.getStime());
