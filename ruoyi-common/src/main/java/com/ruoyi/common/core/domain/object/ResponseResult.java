...
public class ResponseResult<T> {
     ...
     * @return 返回创建的ResponseResult实例对象
     */
    public static ResponseResult<Void> create(int code, String errorMessage) {
        return code == 200 ? success() : error(code, errorMessage);
    }
     ...
     * @return 返回创建的ResponseResult实例对象
     */
    public static <T> ResponseResult<T> error(int code, String errorMessage) {
    ...
    private ResponseResult(int code, String errorMessage) {
        this.success = false;
        this.code = code;
        this.errorMessage = errorMessage;
    }
